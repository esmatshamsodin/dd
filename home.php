      ...
      <footer>
        ...
        <div class="col-md-12">
          ...
          <table class="table" style="background-color: lightgray;">
              ...
              $sql = "SELECT * FROM maketable where hause_id>0";
              ...
              if($result->num_rows > 0) {
                  ...
                  while($row = $result->fetch_assoc()) {
                      ...
                      echo "<tr>
                          ...
                          <td>".$row['id']."</td> 
                          <td>
                          <a  href='update.php?hause_id=".$row['hause_id']."'><button style='width:100px;' class='btn btn-success' type='button'>Edit</button></a>
